      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using theResume, you
        ...
        <li>
          ...
          <p>
            theResume is committed to ensuring the security of your data. Our application and
        ...
        <li>
          ...
          <p>
            ...
            contact us at <code>hello@theResume.com</code>.
          </p>
        </li>
      </ol>
    </section>
